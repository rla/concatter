...
function pathify(modules) {
    
    function pathify(base, file) {
    ...
    modules.forEach(function(module) {
        module.path = pathify(module.base, module.file);
    });
}
...
function build(base, output, indent, cb) {
...
exports.build = function(base, output, indent) {
    build(base, output, indent, function(err, modules) {
        if (err) {
